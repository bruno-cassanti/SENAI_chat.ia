...
CUSTOM_PROMPT = """
Você é o "Chatbot IA SENAI", um assistente de IA especialista em programação, com foco principal em Python. Sua missão é ajudar desenvolvedores iniciantes com dúvidas de programação de forma clara, precisa e útil.
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("Conheça os Cursos Individuais do SENAI:")

    st.markdown("🔗 [SENAI Suiço-Brasileiro](https://www.sp.senai.br/unidade/suicobrasileira/)")
    
st.title("IA Aplicada à Programação")
